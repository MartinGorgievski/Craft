...
namespace Craft.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        {
            var craftMyPcContext = _context.Articles.Include(a => a.CategoryNews);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ImageName,Descriprion,MetaDescription,MetaTitle,KeyWords,DateAdded,DateModified,Author,CategoryNewsId")] Articles articles)
        {
            if (id != articles.Id)
            {
                return NotFound();
